...
| map weights | nominal sum 256; resolution sum is 250,251,252,253,254,255 by area thresholds 320×240, 400×300, 512×384, 800×600, 1280×960, else |
...
Above 8-bit, per-mode thresholds are modified: nuclide ×1.3; chasers −50;
